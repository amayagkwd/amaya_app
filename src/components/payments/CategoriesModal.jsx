...
export default function CategoriesModal({ isOpen, onClose, data, updateStore }) {
  ...
  return (
    <>
      ...
      <div style={{
        ...
        <h2 style={{ fontSize: '20px', margin: '0 0 24px 0' }}>Manage Categories</h2>
...
function CategorySection({ title, categories, onDelete, onRename, hasTransactions, updateStore, type, toggleClassification }) {
